(function ($angular) {
    ...
    var module = $angular.module('ngDroplet', []).directive('droplet', ['$rootScope', '$window', '$timeout', '$q', '$modal',

    function DropletDirective($rootScope, $window, $timeout, $q, $modal) {
        ...
        return {
             ...
             * @return {void}
             */
            controller: ['$scope', '$modal', function DropletController($scope, $modal) {
                ...
                $scope.massagecancel = function () {
                    if ($scope.massageInstance) {
                        $scope.massageInstance.dismiss('cancel');
                    }
                };
                    ...
                    $scope.DropletModel.prototype = {
                        ...
                        deleteFile: function deleteFile() {
                            if (this.Default != "true") {
                                ...
                                $scope.Message = "Cannot delete the default file.";
                                $scope.massageInstance = $modal.open({
                                    templateUrl: 'app/views/amz/messagePopup.html',
                                    scope: $scope,
                                    size: "sm"
    ...
    }]).directive('dropletPreview', ['$window', function DropletPreviewDirective($window, $modal) {
        ...
        return {
             ...
             * @type {String}
             */
            template: '<span><img ng-show="model.isImage()" src="' + blankImage + '" style="background-image: url({{imageData}})" class="droplet-preview" /> <input type="radio" name="defaultImage" ng-model="model.Default" value="true" /></span>',
