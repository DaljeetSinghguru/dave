app.controller('ItemListBySerachText', ['$scope','$route', '$window', '$location', '$modal', '$rootScope', '$http', 'ViewVariablesService', '$translate', '$location',
    function ($scope, $route, $window, $location, $modal, $rootScope, $http, ViewVariablesService, $translate, $location) {
        ...
        var searchtext = $route.current.params.id;

       
        $http({ method: 'POST', url: $scope.Url + 'Search/Request/?Searchtext=' + searchtext }).
